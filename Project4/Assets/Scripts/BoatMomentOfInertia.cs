...
public class BoatMomentOfInertia : MonoBehaviour
{
    ...
    public _h2 _h2;
    public Mh2 mh2;
    public TotalMomentOfInertia totalMomentOfInertia;
    ...
    void Start()
    {
        ...
        mass = new Mass
        {
            ...
            pilot = mass.pilot,
            gun = mass.gun,
            total = (float)Math.Ceiling(mass.hull
                + mass.pilot
                + mass.gun)
        };

        //Debug.Log(mass.hull + " " + mass.pilot + " " + mass.gun + " " + mass.total);
